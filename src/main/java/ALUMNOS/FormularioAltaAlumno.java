...
public class FormularioAltaAlumno extends javax.swing.JFrame {
    
    private List<ModeloDatos.Carrera> carreras = new ArrayList();
    
    public FormularioAltaAlumno() {
        initComponents();
        obtenerCarrerasDisponibles();
    }
    
    // Llenar combobox de carreras disponibles
    private void obtenerCarrerasDisponibles(){
    ...
    private void initComponents() {
        ...
        panel_datos_personales.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de contacto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        panel_datos_contacto.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de contacto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        panle_datos_escolares.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de contacto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        panle_datos_escolaresLayout.setHorizontalGroup(
            ...
            .addGroup(panle_datos_escolaresLayout.createSequentialGroup()
                ...
                .addGroup(panle_datos_escolaresLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(combo_carrera, 0, 253, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addContainerGap()
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(panle_datos_escolares, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    // Validar campos del formulario y agregar datos a Base de Datos
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        
        // Validar que no existan campos vacios en el formulario
        if(campo_nombre.getText().isEmpty() || campo_direccion.getText().isEmpty() ||
           campo_curp.getText().isEmpty() || campo_telefono.getText().isEmpty() ||
           campo_correo.getText().isEmpty() || campo_matricula.getText().isEmpty() ||
           campo_semestre.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Error: Todos los campos del formulario deben ser llenados para continuar.",
                                          "Actividad Complementaria", 0);
            return;
        }
        
        Object[] campos_contacto = new Object[3];
        Object[] campos_escolares = new Object[4];
        Object[] campos_alumno = new Object[7];
        ...
        campos_escolares[2] = carreras.get(combo_carrera.getSelectedIndex()).getId_carrera();
        
        campos_alumno[0] = campo_nombre.getText();
        campos_alumno[1] = campo_direccion.getText();
        campos_alumno[2] = campo_curp.getText();
        
        BaseDeDatos.GestionAlumnos.agregarRegistroAlumno(campos_alumno, campos_contacto, campos_escolares);
